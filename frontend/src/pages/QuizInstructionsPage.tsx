...
export function QuizInstructionsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 pb-12">
      <Link to="/member/quizzes" className="text-xs font-semibold text-slate-500 hover:text-amber-600 flex items-center gap-1">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 lg:p-8 space-y-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
          {[
            ...
            <div key={label as string} className="p-3 bg-slate-50 rounded-xl border border-slate-200">
              <span className="material-symbols-outlined text-amber-600 text-lg">{icon as string}</span>
        ...
        {availability && !availability.open ? (
          ...
          <button
            ...
            className="w-full py-3 bg-amber-600 hover:bg-amber-700 disabled:opacity-60 text-white rounded-xl font-bold text-sm shadow-md shadow-amber-500/20 flex items-center justify-center gap-2"
          >
