    ...
    >
      <div className="space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200 text-xs">
          ...
          {reference.page != null && (
            <span className="px-2.5 py-1 rounded-md bg-blue-100 text-blue-800 font-bold shrink-0">
        ...
        {reference.snippet && (
          <div className="border border-slate-200 rounded-xl overflow-hidden">
            ...
            <blockquote className="p-4 bg-slate-900 text-slate-200 text-xs leading-relaxed border-l-4 border-blue-500">
              “{reference.snippet}”
            </blockquote>
          </div>
        )}
        ...
        {reference.url && (
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-bold"
          >
